public class GameBoard {
    ...
    public int getValue(int dieSum) {
        String output = switch (dieSum){
            ...
            case 4 -> "Congratulations! You have reached the Palace Gates and has found 100 gold coins.";
            case 5 -> "Oh no! You have reached the Cold Desert.... You lost 20 gold coins";
            case 6 -> "Congratulations! You have reached the Goldmine and has found 180 gold coins.";
            ...
            case 9 -> "Congratulations! You have reached the Huts in the Mountain and has found 60 gold coins.";
            ...
            case 12 -> "Congratulations! You have reached the Goldmine and has found 650 gold coins.";
